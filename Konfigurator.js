...
<body>
  <form id="konfigurator">
    <img id="XY_Achse" src alt="XY_Achse Bild" style="width:200px;display:none" />

    <label for="länge">Wählen Sie die Länge (Y-Achse) der CNC-4-Home:</label>
    <select id="länge" name="länge">
      ...
      <option value="1200">1.200 mm</option>
      <option value="1300">1.300 mm</option>
    </select>

    <label for="breite">Wählen Sie die Breite (X-Achse) der CNC-4-Home:</label>
    ...
    <select id="Spindel" name="Spindel">
      <option value="ohne">Ohne</option>
      <option value="1.1">1.1 KW</option>
      <option value="2.2">2.2 KW</option>
    </select>
    <img id="SpindelBild" src alt="Spindel Bild" style="width:200px;display:none" />

    <label for="Steuerung">E-Steuerung</label>
    <select id="Steuerung" name="Steuerung">
      <option value="nichts">ohne</option>
      <option value="Schaltschrank">Schaltschrank verkabelt</option>
    </select>
    <img id="SteuerungBild" src alt="Steuerung Bild" style="width:200px;display:none" />

    <label for="Vakuumplatte">Vakuumplatte</label>
    <select id="Vakuumplatte" name="Vakuumplatte">
      <option value="Nein">Nein</option>
      <option value="Ja">Ja</option>
    </select>
    <img id="VakuumplatteBild" src alt="Vakuumplatte Bild" style="width:200px;display:none" />

    <label for="Absaugung">Absaugung</label>
    <select id="Absaugung" name="Absaugung">
      <option value="Ohne">ohne</option>
      <option value="Absaugungseinheit">Absaugungseinheit</option>
    </select>
    <img id="AbsaugungBild" src alt="Absaugung Bild" style="width:200px;display:none" />

    <label for="Antrieb">Antrieb</label>
    <select id="Antrieb" name="Antrieb">
      <option value="Riementrieb">Riementrieb</option>
      <option value="Kugelumlaufspindel">Kugelumlaufspindel</option>
    </select>
    <img id="AntriebBild" src alt="Antrieb Bild" style="width:200px;display:none" />

    <label for="Motor">Motor</label>
    <select id="Motor" name="Motor">
      <option value="ohne">Ohne</option>
      <option value="Closed-Loop Schrittmotor">Schrittmotor</option>
      <option value="Servomotor">Servomotor (X & Y) + Closed Loop (Z)</option>
    </select>
    <img id="MotorBild" src alt="Motor Bild" style="width:200px;display:none" />

    <label for="Preis">Gesamtpreis</label>
    <p id="preis">0.00 €</p>

    <button type="button" id="Downloadbutton">Stückliste Herunterladen</button>
  </form>
